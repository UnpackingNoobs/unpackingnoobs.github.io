...
![The entry point of original.exe]({{site.url}}/assets/lection_1/ep_original.png)\
![The entry point of packed.exe]({{site.url}}/assets/lection_1/hexeditor.png)
